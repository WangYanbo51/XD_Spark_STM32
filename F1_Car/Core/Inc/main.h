...
#define R_IN1_Pin GPIO_PIN_6
#define R_IN1_GPIO_Port GPIOA
#define R_IN2_Pin GPIO_PIN_7
#define R_IN2_GPIO_Port GPIOA
#define R_IN3_Pin GPIO_PIN_0
#define R_IN3_GPIO_Port GPIOB
#define R_IN4_Pin GPIO_PIN_1
#define R_IN4_GPIO_Port GPIOB
#define L_IN3_Pin GPIO_PIN_10
#define L_IN3_GPIO_Port GPIOB
#define L_IN4_Pin GPIO_PIN_11
#define L_IN4_GPIO_Port GPIOB
